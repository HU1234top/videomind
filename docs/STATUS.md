...
| Unit Tests | `src/core/rate-limiter.test.mjs`, `src/sinks/obsidian.test.mjs`, `src/core/pipeline.test.mjs`, `src/core/checkpoint.test.mjs`, `src/analyzers/doubao-json.test.mjs`, `src/core/logger.test.mjs`, `src/core/config.test.mjs` | 167 cases total: rate limiter (29), obsidian vault (23), e2e pipeline (10), checkpoint (21), JSON parser (29), structured logger (18), config validation (37) |
